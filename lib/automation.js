...
async function bookAppointment(data) {
    ...
    try {
        ...
        await page.goto('https://app.instacare.pk/appointments', { waitUntil: 'domcontentloaded' });
        ...
        // Skip the sidebar click, go straight to portal
        await page.waitForSelector('.open-appointment-portal', { timeout: 10000 });
        await page.click('.open-appointment-portal');
